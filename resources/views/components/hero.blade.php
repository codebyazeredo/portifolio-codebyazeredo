    ...
    <div class="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div class="text-white">
            <h1 class="text-5xl md:text-6xl font-bold mb-4">
                {{ $title }}
                <span class="block text-yellow-300 typing-effect">{{ $name }}</span>
            </h1>
        ...
        <div class="flex justify-center">
            <div class="relative">
                <div class="w-80 h-80 bg-white bg-opacity-20 rounded-full flex items-center justify-center backdrop-blur-sm">
                    <img src="{{ asset('images/eu.png') }}" alt="Minha imagem" class="rounded-full w-full h-full object-cover">
                </div>
