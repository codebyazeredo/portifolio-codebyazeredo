<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    ...
    <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <a href="<?php echo e($project['url']); ?>" target="_blank"
            ...
            ?>
            <span class="absolute top-3 right-3 px-2 py-0.5 text-xs font-semibold rounded-full <?php echo e($statusColor); ?>">
            ...
            <div>
                <h3 class="text-gray-900 font-semibold text-xl mb-2"><?php echo e($project['name']); ?></h3>
                <p class="text-gray-600 text-sm mb-4"><?php echo e($project['description']); ?></p>
            </div>
...
<?php /**PATH C:\laragon\www\portifolio-codebyazeredo\resources\views/components/projects.blade.php ENDPATH**/ ?>